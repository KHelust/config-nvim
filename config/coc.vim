" Conquer of Completion comfiguration
...
xmap oif <Plug>(coc-funcobj-i)
omap oif <Plug>(coc-funcobj-i)
xmap oaf <Plug>(coc-funcobj-a)
omap oaf <Plug>(coc-funcobj-a)
xmap oic <Plug>(coc-classobj-i)
omap oic <Plug>(coc-classobj-i)
xmap oac <Plug>(coc-classobj-a)
omap oac <Plug>(coc-classobj-a)
...
" Show commands.
nnoremap <silent><nowait> <space>ol  :<C-u>CocList commands<cr>
...
nnoremap <silent><nowait> <space>oi  :<C-u>CocListResume<CR>
