...
" Prefix dictionary
  ...
  let g:which_key_map.c.p.o = 'Abrir archivo vinculado'
  ...
  let g:which_key_map.f.e = 'Telescope Explorador de archivos'
  ...
  let g:which_key_map.f.o = 'Telescope Archivos anteriores'
  ...
  let g:which_key_map.f.v = 'Telescope Buscar en el buffer actual'
  ...
  let g:which_key_map.g.t = 'Telescope git stash'
