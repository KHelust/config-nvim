...
>>>>>>> origin/master
  ...
  let g:which_key_map.f.c = 'Telescope mostrar comandos'
  let g:which_key_map.f.d = 'Telescope historial comandos'
  let g:which_key_map.f.f = 'Telescope buscar archivos'
  let g:which_key_map.f.g = 'Telescope hacer búsqueda'
  let g:which_key_map.f.h = 'Telescope historial archivos'
  let g:which_key_map.f.k = 'Telescope atajos de teclado'
  let g:which_key_map.f.m = 'Telescope Man pages'
  let g:which_key_map.f.o = 'Telescope Archivos abiertos'
  let g:which_key_map.f.q = 'Telescope quickfix'
  let g:which_key_map.f.r = 'Telescope registers'
  let g:which_key_map.f.s = 'Telescope colorSchemes'
  ...
  let g:which_key_map.g.f = 'Telescope git files'
  let g:which_key_map.g.g = 'Git'
  let g:which_key_map.g.p = 'Git push'
  let g:which_key_map.g.r = 'Telescope git branches'
  let g:which_key_map.g.s = 'Telescope git status'
  ...
  let g:which_key_map.h.t = 'Telescope help tags'
