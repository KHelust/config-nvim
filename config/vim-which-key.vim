...
" Prefix dictionary
  ...
  let g:which_key_map.f.h = 'Telescope Historial de búsqueda'
  let g:which_key_map.f.k = 'Telescope Atajos de teclado'
  let g:which_key_map.f.m = 'Telescope Man pages'
  let g:which_key_map.f.o = 'Telescope Historial archivos'
  ...
  let g:which_key_map.f.v = 'Telescope Vim options'
